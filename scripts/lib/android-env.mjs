/**
 * Resolve the toolchain paths Gradle needs before an Android build.
 *
...
/**
 * The environment overlay an Android build needs, or exit 1 explaining which
 * half is missing.
 *
 * @returns {{ env: Record<string, string>, sdk: string, jdk: { home: string, major: number } }}
 */
...
/** Print which toolchain was picked, so a wrong JDK is visible in the log. */
export function announceAndroidEnv({ sdk, jdk }) {
